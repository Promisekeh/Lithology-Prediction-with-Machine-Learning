...
## Aim
This research aims to produce a model to automate lithology interpretation from well logs.

## Objectives
* Evaluate and improve the winning model from the FORCE competition.
* Apply different ML (XGboost, RF and CATboost) classifiers to obtain best predictive model
